                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <h5>Administrar Solicitudes Reserva</h5>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="card">
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['cambioValido'])){
                                        ...
                                        echo '<div class="alert alert-success alert-dismissible">
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                        <h5><i class="fa fa-check"></i>&nbsp;Cantidad de Materiales Añadida Correctamente!</h5></div>';
                                    ...
                                    if(isset($_GET['vacios'])){
                                        ...
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                        <h5><i class="fa fa-exclamation"></i>&nbsp;Error al ingresar, intente nuevamente!</h5></div>';
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <div class="small-box bg-info">
                                                ...
                                                <div class="inner">
                                                    ...
                                                    <h4>Ingresar Solicitud Reserva</h4>
                                                    <h5>
                                                ...
                                                <a href="reservar-soli-compra.php" class="small-box-footer">Ingresar <i class="fas fa-arrow-circle-right"></i></a>
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <div class="small-box bg-success">
                                                ...
                                                <a href="historial-soli-reservas.php" class="small-box-footer">Visualizar <i class="fas fa-arrow-circle-right"></i></a>
