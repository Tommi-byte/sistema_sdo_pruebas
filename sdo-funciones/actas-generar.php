            ...
            if ($resFolio) {
                if (isset($_POST['patente1'], $_POST['patente2'], $_POST['modelo1'], $_POST['modelo2'])) {
                    ...
                    if (empty($patente1) || empty($modelo1)) {
                        header('Location: ../sdo-personal/actas-listado.php?exitoCrearActa=true&vehiculo1Vacio=true');
                    } else {
                        if (buscarPatente($patente1) == 0 || empty(buscarPatente($patente1))) {
                            ...
                            if ($resParking1) {
                                if (empty($patente2) || empty($modelo2)) {
                                    header('Location: ../sdo-personal/actas-listado.php?exitoCrearActa=true&soloVehiculo1=true');
                                } else {
                                    if (buscarPatente($patente2) == 0 || empty(buscarPatente($patente2))) {
                                        ...
                                        if ($resParking2) {
                                            header('Location: ../sdo-personal/actas-listado.php?exitoCrearActaVehiculo1y2=true');
                                        } else {
                                            header('Location: ../sdo-personal/actas-listado.php?exitoCrearActa=true&soloVehiculo1=true&errorVehiculo2=true');
                                        }
                                    } else {
                                        header('Location: ../sdo-personal/actas-listado.php?exitoCrearActa=true&soloVehiculo1=true&existePatente2=true');
                                    }
                                }
                            } else {
                                header('Location: ../sdo-personal/actas-listado.php?exitoCrearActa=true&errorVehiculo1=true');
                            }
                        } else {
                            header('Location: ../sdo-personal/actas-listado.php?exitoCrearActa=true&existePatente1=true');
                        }
                    }
                } else {
                    header('Location: ../sdo-personal/actas-listado.php?exitoCrearActa=true&sinEstacionamiento=true');
                }
            } else {
                header('Location: ../sdo-personal/actas-listado.php?errorCrearFolio=true');
            }
        } else {
            header('Location: ../sdo-personal/actas-listado.php?errorCrearActa=true');
        }
    } else {
    }
} else {
