...
<head>
    ...
    <title>Firmar Orden de Trabajo</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        <?php
        include '../sdo-templates/user-sidebar.php';
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <form action="../sdo-funciones/ordenes-agregarFirmas.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <!-- left column -->
                            <div class="col-md-12">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="exampleInputFecha">Fecha de Orden de Trabajo:</label>
