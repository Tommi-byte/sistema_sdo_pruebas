...
if (isset($_POST['addNomEquipo'], $_POST['categoriaAgregar'])) {
    ...
    if(!empty($addNomEquipo) && !empty($categoriaAgregar) && $categoriaAgregar > 0){
        ...
        if($existeEquipo == 0){
            ...
            if ($res) {
                header('Location: ../sdo-administrador/sistemas-visualizar.php?exitoAgregarEquipo=true');
            } else {
                header('Location: ../sdo-administrador/sistemas-visualizar.php?errorAgregarEquipo=true');
            }
        }else{
            header('Location: ../sdo-administrador/sistemas-visualizar.php?existeEquipo=true');
        }
    }else{
        header('Location: ../sdo-administrador/sistemas-visualizar.php?errorAgregarEquipo=true');
    }
