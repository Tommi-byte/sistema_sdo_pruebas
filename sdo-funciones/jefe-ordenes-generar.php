...
if (isset($_POST['nomSolicitante'], $_POST['nomTecnicoRecepcionador'], $_POST['servicioOrden'], $_POST['departamentoSolicitante'], $_POST['recintoOrden'], $_POST['pmaOrden'], $_POST['coordenadasOrden'], $_POST['detalleTrabajo'], $_POST['comentariosTrabajos'], $_POST['fechaActualOrden'])) {
    ...
    if ($nomSolicitante == '' || $nomSolicitante == ' ' || empty($nomSolicitante) || $servicioOrden == '' || $servicioOrden == ' ' || empty($servicioOrden) || $recintoOrden == '' || $recintoOrden == ' ' || empty($recintoOrden)) {
        header('Location: ../sdo-jefestecnicos/ordenes-formulario.php?errorGenerar=true');
    } else {
        if ($pmaOrden == '' || $pmaOrden == ' ' || empty($pmaOrden) || $departamentoSolicitante == '' || $departamentoSolicitante == ' ' || empty($departamentoSolicitante) || $coordenadasOrden == '' || $coordenadasOrden == ' ' || empty($coordenadasOrden) || $detalleTrabajo == '' || $detalleTrabajo == ' ' || empty($detalleTrabajo)) {
            ...
            if ($resOrden) {
                ...
                if ($resFolio) {
                    ...
                    if (isset($_FILES["archivoImagenOrden"])) {
                        ...
                        for ($i = 0; $i < $tot; $i++) {
                            ...
                            if ($tmp_name == '' || $tmp_name == ' ' || empty($tmp_name)) {
                                ...
                                header('Location: ../sdo-funciones/jefe-firmarOrdenTrabajo.php');
                                // if ($usoMaterial == 'Vacio') {
                                //     header('Location: ../sdo-jefestecnicos/ordenes-listado.php?ordenSinFotoSinMaterial=true');
                                // } else if ($usoMaterial == 'Usando') {
                                //     header('Location: ../sdo-jefestecnicos/ordenes-listado.php?ordenSinFotoConMaterial=true');
                                // } else {
                                //     header('Location: ../sdo-jefestecnicos/ordenes-listado.php?ordenSinFotoSinMaterial=true');
                                // }
                            } else {
                                ...
                                if ($extImagen == "jpg" || $extImagen == "png" || $extImagen == "jpeg" || $extImagen == "bmp" || $extImagen == "tif" || $extImagen == "webp" || $extImagen == "svg" || $extImagen == "jfif") {
                                    ...
                                    if (move_uploaded_file($tmp_name, $ruta)) {
                                        ...
                                        if ($resImagen) {
                                            ...
                                            //     header('Location: ../sdo-jefestecnicos/ordenes-listado.php?ordenConFotoSinMaterial=true');
                                            // } else if ($usoMaterial == 'Usando') {
                                            //     header('Location: ../sdo-jefestecnicos/ordenes-listado.php?ordenConFotoConMaterial=true');
                                            // } else {
                                            //     header('Location: ../sdo-jefestecnicos/ordenes-listado.php?ordenConFotoSinMaterial=true');
                                            // }
                                        } else {
                                            ...
                                            header('Location: ../sdo-funciones/jefe-firmarOrdenTrabajo.php');
                                            // if ($usoMaterial == 'Vacio') {
                                            //     header('Location: ../sdo-jefestecnicos/ordenes-listado.php?errorCargaFotoSinMaterial=true');
                                            // } else if ($usoMaterial == 'Usando') {
                                            //     header('Location: ../sdo-jefestecnicos/ordenes-listado.php?errorCargaFotoConMaterial=true');
                                            // } else {
                                            //     header('Location: ../sdo-jefestecnicos/ordenes-listado.php?errorCargaFotoSinMaterial=true');
                                            // }
                                        }
                                    ...
                                    header('Location: ../sdo-funciones/jefe-firmarOrdenTrabajo.php');
                                    // if ($usoMaterial == 'Vacio') {
                                    //     header('Location: ../sdo-jefestecnicos/ordenes-listado.php?formatoIncorrectoFotoSinMaterial=true');
                                    // } else if ($usoMaterial == 'Usando') {
                                    //     header('Location: ../sdo-jefestecnicos/ordenes-listado.php?formatoIncorrectoFotoConMaterial=true');
                                    // } else {
                                    //     header('Location: ../sdo-jefestecnicos/ordenes-listado.php?formatoIncorrectoFotoSinMaterial=true');
                                    // }
                                }
                    ...
                    header('Location: ../sdo-jefestecnicos/ordenes-listado.php?errorFolio=true');
                }
            } else {
                header('Location: ../sdo-jefestecnicos/ordenes-formulario.php?errorGenerar=true');
            }
