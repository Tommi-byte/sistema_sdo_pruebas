...
if (isset($_POST['idOrden'], $_POST['detalleTrabajo'], $_POST['comentariosTrabajos'])) {
    ...
    if (!empty($idOrden) && !empty($detalleTrabajo)) {
        ...
        if ($resModOrden) {
            header('Location: ../sdo-jefestecnicos/ordenes-listado.php?exitoModificarOrden=true');

        } else {
            header('Location: ../sdo-jefestecnicos/ordenes-listado.php?errorModificarOrden=true');
        }
    } else {
        header('Location: ../sdo-jefestecnicos/ordenes-listado.php?errorModificarOrden=true');
    }
