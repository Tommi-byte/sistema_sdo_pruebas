...
if (isset($_POST['idJefe'], $_POST['modNombre'], $_POST['modUser'], $_POST['modPassword'], $_POST['departamentoModificar'])) {
    ...
    if ($idJefe > 0) {
        ...
        if ($modNombre == '' || empty($modNombre) || $modUser == '' || empty($modUser) || $passUser == '' || empty($passUser) || $departamentoModificar == '' || empty($departamentoModificar)) {
            header('Location: ../sdo-administrador/jefes-administrar.php?errorModificarJefe=true');
        } else {
            ...
            if ($resModificar) {
                header('Location: ../sdo-administrador/jefes-administrar.php?exitoModificarJefe=true');
            } else {
                header('Location: ../sdo-administrador/jefes-administrar.php?errorModificarJefe=true');
            }
        }
    ...
    header('Location: ../sdo-administrador/jefes-administrar.php?errorSeleccionarModificarJefe=true');
}
